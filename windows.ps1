## SOURCE: https://raw.githubusercontent.com/jayharris/dotfiles-windows/master/windows.ps1
## CREDIT: Jay Harris (https://github.com/jayharris)
...
# Set Computer Name
(Get-WmiObject Win32_ComputerSystem).Rename("MJM-Desktop") | Out-Null
...
Set-ItemProperty "HKCU:\SOFTWARE\Microsoft\TabletTip\1.7" "EnableAutocorrection" 1
...
### Apperance                                                                 #
###############################################################################
Write-Host "Configuring Apperance..." -ForegroundColor "Yellow"

# Turn on Dark Mode for Windows
...
Update-Pins("Microsoft Edge")
Update-Pins("Microsoft Store")
